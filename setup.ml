...
(* OASIS_START *)
(* DO NOT EDIT (digest: cdaa2767b8b588194752b0bdbd32e040) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Inheap_memory"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "memory";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "memory";
                           InternalLibrary "memory_xenctrl";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "B\205A\182+ot\021\225\1694X\195%\206]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
